class Track {
    ...
    public constructor (deadline: Date, maxArticulos: Number, formaSeleccion: FormaSeleccionEnum) {
    ...
    public agregarArticulo(articulo: Articulo) {
        const foundArticle = this.articulos.find(art => art.getTitulo() === articulo.getTitulo());
        if (foundArticle) {
